...
/*
 *Flavio C閟ar Betanco Amaya		
 *Sergio Enrique P閞ez Figueroa            
 *H閏tor David Maradiaga Garc韆           
*/
...
public class MenuPrincipal extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Men煤 Principal"));
	...
	private void clickCrearTabla(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clickCrearTabla
		...
		if (cCrearTab == 0) {
			...
			jLTabla.setText("**Se cre贸 la tabla " + this.tabla.getNombre());
	...
	private void clickCrearCampo(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clickCrearCampo
		...
		if (this.cCrearTab == 0) {
			...
			descripcion = JOptionPane.showInputDialog("Ingrese la descripci贸n del campo ");
			...
			jLCampo.setText("**Se cre贸 el campo " + nombre);
			m++;
		} else {
	...
	private void clickActRegistro(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clickActRegistro
		...
		if (this.cCrearTab == 0) {
			...
			this.clickImpTabla(evt);
			jLRegistro.setText("**Se actualiz贸 el registro " + num);
