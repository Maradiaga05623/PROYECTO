...
public class Tabla<T> {
	...
	public void agregarCampo(T nombre, T descripcion, T tipoDato) {
	...
	//Metodo privado para crear una definición de campo
	private void crearCampoDef(T nombre, T descripcion, T tipoDato) {
